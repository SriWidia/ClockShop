...
<main class="p-6 flex space-x-6">
  <div class="bg-gray-200 p-6 w-1/4 rounded-lg shadow-md">
    <h2 class="font-bold text-lg mb-4">Tambah Pelanggan</h2>
    ...
    <form action="addpelanggan.php" method="post" class="space-y-4">
      <div>
        <label class="block text-sm font-semibold">Nama Pelanggan</label>
        <input type="text" name="nama_pelanggan" class="w-full p-2 border rounded-md text-black"/>
      </div>
      <div>
        <label class="block text-sm font-semibold">alamat</label>
        <input type="text" name="alamat" class="w-full p-2 border rounded-md text-black"/>
      </div>
      <div>
        <label class="block text-sm font-semibold">No Handphone</label>
        <input type="text" name="no_telepon" class="w-full p-2 border rounded-md text-black"/>
      </div>
  ...
  <div class="bg-gray-300 flex-1 p-6 rounded-lg shadow-md">
    <h2 class="text-lg">Daftar Pelanggan</h2>
    <div id="PelangganList">
      <?php include 'tampilkanpelanggan.php'; ?>
    </div>
  </div>
</main>
