...
// Query untuk mengambil data penjualan dan nama kasir
...
<body class="bg-blue-100 p-5">
    <div class="max-w-4xl mx-auto bg-white p-6 shadow-lg rounded-lg mt-5">
        ...
        <div class="mt-4">
            <a href="cetak_struk.php?idpenjualan=<?php echo $penjualan['idpenjualan']; ?>" target="_blank" class="bg-green-500 text-white px-3 py-1 rounded-md hover:bg-green-700">Cetak Struk</a>
        </div>
    </div>
</body>
<script>
